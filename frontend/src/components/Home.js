...
const NewUserHomePage = () => {
    return (
        <div className="Home container">
            ...
            <h3>Let's begin your personalized recommendations journey.</h3>
            <h4>Get on board and sign-up here to receive expert recommendations tailored to your needs.</h4>
